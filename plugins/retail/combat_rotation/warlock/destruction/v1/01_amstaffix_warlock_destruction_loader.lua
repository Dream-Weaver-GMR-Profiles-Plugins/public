...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/warlock/destruction/v1/90_amstaffix_warlock_destruction_rotation.gmr"
---@type DFWarlockDestructionV1Config
local Config = {
...
if UnitClassBase("player") == "WARLOCK" and (GetSpecialization() == 5 or GetSpecialization() == 3) then
    local msgPrefix = "[" .. ID .. "] "
