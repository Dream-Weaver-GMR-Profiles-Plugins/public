...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/druid/guardian/v1/90_amstaffix_druid_guardian_rotation.gmr"
---@type DFDruidGuardianV1Config
local Config = {
    ...
    useMaulWithViciousCycleMinHP = 70,
    useBristlingFurMinHP = 60,
    usePulverizeMinHP = 55,
    usePulverizeAsPartOfBurst = false,
    useSurvivalInstinctsMinHP = 50,
    useFrenziedRegenerationMinHP = 65,
    useRegrowthUnderDreamOfCenariusMinHP = 80,
    useRageOfTheSleeperMinHP = 85,
    useBarskinMinHP = 80,
    useRenewalMinHP = 70,
...
if UnitClassBase("player") == "DRUID" and (GetSpecialization() == 5 or GetSpecialization() == 3) then
    local msgPrefix = "[" .. ID .. "] "
