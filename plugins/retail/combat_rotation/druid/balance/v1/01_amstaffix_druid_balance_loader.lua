...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/druid/balance/v1/90_amstaffix_druid_balance_rotation.gmr"
---@type DFDruidBalanceV1Config
local Config = {
    ...
    singleTargetEclipsePriority = 1, -- 1:lunar; 2:solar

    useForceOfNature = true,

    useSolarBeam = true,

    useOptimizationToReduceEclipseCD = true,

    minEneminesToAoe = 3,

    minEnemiesToSpreadInstantDots = 2,

    useStellarFlareToSpread = false,
    useStellarFlareMinEnemiesToStartSpread = 2,
    useStellarFlareMinHPToSpread = 80,

    useFrenziedRegenerationMinHP = 65,

    useRejuvenationMinHP = 95,
...
if UnitClassBase("player") == "DRUID" and (GetSpecialization() == 5 or GetSpecialization() == 1) then
    local msgPrefix = "[" .. ID .. "] "
