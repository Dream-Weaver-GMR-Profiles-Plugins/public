...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/demonhunter/vengeance/v1/90_amstaffix_demonhunter_vengeance_rotation.gmr"
---@type DFDemonHunterVengeanceV1Config
local Config = {
    ...
    useInfernalStrikeOnPlayer = true, -- true = player, false = target
    useElysianDecreeMinEnemies = 1,
    useSigilOfFlameMinEnemies = 1,
    useSpiritBombMinEnemies = 1,
...
if GMR.GetClass("player") == amstlib.CONST.CLASS.DEMONHUNTER and GetSpecialization() == 2 then
    local msgPrefix = "[" .. ID .. "] "
