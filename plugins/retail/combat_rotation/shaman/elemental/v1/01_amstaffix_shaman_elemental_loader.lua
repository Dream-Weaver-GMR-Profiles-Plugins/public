...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/shaman/elemental/v1/90_amstaffix_shaman_elemental_rotation.gmr"
---@type DFShamanElementalV1Config
local Config = {
...
if UnitClassBase("player") == "SHAMAN" and (GetSpecialization() == 5 or GetSpecialization() == 1) then
    local msgPrefix = "[" .. ID .. "] "
