...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/retail/combat_rotation/warrior/fury/v1/90_amstaffix_warrior_fury_rotation.gmr"
---@type RetailWarriorFuryV1Config
local Config = {
...
if UnitClassBase("player") == "WARRIOR" and (GetSpecialization() == 5 or GetSpecialization() == 2) then
    local msgPrefix = "[" .. ID .. "] "
