...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/warrior/protection/v1/90_amstaffix_warrior_protection_rotation.gmr"
---@type WarriorProtectionV1Config
local Config = {
...
if GMR.GetClass("player") == "WARRIOR" then
    local msgPrefix = "[" .. ID .. "] "
