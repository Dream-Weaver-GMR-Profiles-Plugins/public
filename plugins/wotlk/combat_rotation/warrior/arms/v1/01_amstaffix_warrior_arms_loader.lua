...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/warrior/arms/v1/90_amstaffix_warrior_arms_rotation.gmr"
---@type WarriorArmsV1Config
local Config = {
