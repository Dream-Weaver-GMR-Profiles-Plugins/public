...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/rogue/subtlety/v1/90_amstaffix_rogue_subtlety_rotation.gmr"
---@type RogueSubtletyV1Config
local Config = {
...
if GMR.GetClass("player") == amstlib.CONST.CLASS.ROGUE then
    local msgPrefix = "[" .. ID .. "] "
