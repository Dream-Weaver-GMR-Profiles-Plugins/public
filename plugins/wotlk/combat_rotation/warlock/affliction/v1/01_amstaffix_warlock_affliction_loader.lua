...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/warlock/affliction/v1/90_amstaffix_warlock_affliction_rotation.gmr"
---@type WarlockAfflictionV1Config
local Config = {
