...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/paladin/holy/v3/90_amstaffix_paladin_holy_rotation.gmr"
---@type PaladinHolyV3Config
local Config = {
