...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/druid/feraltank/v1/90_amstaffix_druid_feraltank_rotation.gmr"
---@type DruidFeralTankV1Config
local Config = {
