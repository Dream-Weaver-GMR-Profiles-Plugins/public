...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/druid/feraldps/v1/90_amstaffix_druid_feraldps_rotation.gmr"
---@type DruidFeralDPSV1Config
local Config = {
