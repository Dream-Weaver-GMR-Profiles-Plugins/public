...
local ROTATION_LINK = "https://raw.githubusercontent.com/Dream-Weaver-GMR-Profiles-Plugins/public/master/plugins/wotlk/combat_rotation/druid/balance/v1/90_amstaffix_druid_balance_rotation.gmr"
---@type DruidBalanceV1Config
local Config = {
